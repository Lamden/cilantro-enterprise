...
from cilantro.crypto.canonical import block_from_subblocks
...
class MasterStorage:
    ...
    def __init__(self, port=27027, config_path=cilantro.__path__[0]):
...
class DistributedMasterStorage(MasterStorage):
    def __init__(self, key, distribute_writes=False, config_path=cilantro.__path__[0], vkbook=None):
...
class CilantroStorageDriver(DistributedMasterStorage):
    def __init__(self, key, distribute_writes=False, config_path=cilantro.__path__[0], **kwargs):
