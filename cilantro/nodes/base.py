...
from cilantro.nodes.catchup import BlockFetcher
from cilantro.storage import MasterStorage

from cilantro.nodes.new_block_inbox import NBNInbox
from cilantro.storage import VKBook
from cilantro.contracts import sync
from cilantro.networking.parameters import Parameters, ServiceType, NetworkParameters
import cilantro
import zmq.asyncio
import asyncio
...
from cilantro.cli.utils import version_reboot
...
class Node:
    def __init__(self, socket_base, ctx: zmq.asyncio.Context, wallet, constitution: dict, overwrite=False,
        ...
        self.client = ContractingClient(driver=self.driver,
                                        submission_filename=cilantro.contracts.__path__[0] + '/submission.s.py')
