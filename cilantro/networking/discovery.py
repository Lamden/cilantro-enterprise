...
import cilantro.sockets.reqrep
import cilantro.sockets.struct
from cilantro.sockets.inbox import SecureAsyncInbox, AsyncInbox
from cilantro.logger.base import get_logger
from cilantro.crypto.wallet import Wallet, _verify
...
async def ping(socket_id: cilantro.sockets.struct.SocketStruct, pepper: bytes, ctx: zmq.Context, timeout, debug=False):
